...
class CameraMenu(Screen):
    ...
    def process_predictions(self, predictions):
        ...
        for prediction in predictions['predictions']:
            ...
            elif class_name == 'puncture wound' and confidence >= 0.7:  # New type
                detected_injuries.append('puncture wound')
                print("Injury found: Puncture wound detected with confidence", confidence)
            elif class_name == 'bite wound' and confidence >= 0.7:  # New type
    ...
    def navigate_to_page(self, injury_types):
        ...
        elif 'puncture wound' in injury_types:
            self.manager.current = 'puncturewoundpage'
        elif 'bite wound' in injury_types:
        ...
        elif 'pressure wound' in injury_types:
